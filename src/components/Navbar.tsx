import { Heart, Menu, X, User, LogOut, Bot, Bell } from "lucide-react";
...
export const Navbar = () => {
  ...
  const { unreadCount, totalCount } = useAlertCount();
  const { isProfessional } = useUserRole();

  // Hide Assistant link for professionals (doctors/advisors/admins)
  const navLinks = [
    { name: "Home", path: "/" },
    { name: "Dashboard", path: "/dashboard" },
    ...(!isProfessional ? [{ name: "Assistant", path: "/chat", icon: Bot }] : []),
